                ...
                <div class="col col-lg-6 col-md-7">
                    <div class="wpo-hero-text">
                        <div class="wpo-hero-title">
                            <h2>已报名用户(管理员）</h2>
                            <a href="AdminMeeting.jsp"><h3 style="color:white">☛返回会议</h3></a>
                        </div>
                        <div class="wpo-hero-para">
                            ...
                            <table id="userTable" style="text-align: center;width: 1000px;color: orange;">
                                ...
                                <tr>
                                    ...
                                    <td><button><a href="AdminUserUpdate.jsp?user_ID=<%=user.getUser_ID()%>&meetingId=<%=user.getMeetingId()%>">修改<a></button></td>
                                    <td><button><a href="AdminUserDelete?user_ID=<%=user.getUser_ID()%>&meetingId=<%=user.getMeetingId()%>">删除</a></button></td>
                                </tr>
                                <%}
                                }
