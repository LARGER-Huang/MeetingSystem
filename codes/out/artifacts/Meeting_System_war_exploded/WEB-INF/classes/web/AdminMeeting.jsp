            ...
            <div class="row">
                <div class="col col-lg-6 col-md-7">
                    <div class="wpo-hero-text">
                        <h2>全部会议（管理员）</h2>
                        <a href="OrgRegister.jsp"><h3 style="color:white">☛添加组织者</h3></a>
                        <div class="wpo-hero-para">
                            ...
                            <table style="text-align: center;width: 1000px;color: orange;">
                                ...
                                <tr>
                                    <td><p><%=org.getOrg_ID()%></p></td>
                                    <td><a href="AdminUserMeeting.jsp?meetingId=<%=org.getMeetingId()%>" ><p><%=org.getMeetingId()%></p></a></td>
                                    <td><p><%=org.getDate()%></p></td>
                                    <td><p><%=org.getPlace()%></p></td>
                                    <td><p><%=org.getSpeaker()%></p></td>
                                    <td><p><%=org.getHotel()%></p></td>
                                    <td><button><a href="AdminMeetingUpdate.jsp?meetingId=<%=org.getMeetingId()%>&org_ID=<%=org.getOrg_ID()%>">修改<a></button></td>
                                    <td><button><a href="AdminMeetingDelete?meetingId=<%=org.getMeetingId()%>&org_ID=<%=org.getOrg_ID()%>">删除</a></button></td>
                                </tr>
                                <%}
                                }
