                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-12">
                            <div class="contact-form">
                                ...
                                <form method="post" action="UserEnroll" class="contact-validation-active" id="contact-form-main">
                                    <label>ID:</label>
                                    <input type="number" class="form-control" name="id"  value="<%=request.getAttribute("user_ID")%>" readonly>

                                    <label>会议号:</label>
                                    <input type="number" class="form-control" name="meetingId" placeholder="会议号不存在或已报名该会议！" required>
