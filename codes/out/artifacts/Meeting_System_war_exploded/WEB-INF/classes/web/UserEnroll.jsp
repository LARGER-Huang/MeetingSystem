                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-12">
                            <div class="contact-form">
                                <h2>个人信息表</h2>
                                <form method="post" action="UserInformation" class="contact-validation-active" id="contact-form-main">
                                    <%
                                        Org org=(Org)request.getAttribute("org");
                                    %>
                                    <label>ID:</label>
                                    <input type="number" class="form-control" name="id"  value="<%=request.getAttribute("user_ID")%>" readonly>

                                    <label>会议号:</label>
                                    <input type="number" class="form-control" name="meetingId" value="<%=org.getMeetingId()%>" readonly>
                                    ...
                                    <div class="submit-area">
                                        <button type="submit" class="theme-btn submit-btn">提交报名</button>
                                        <div id="loader">
                                            <i class="ti-reload"></i>
                                        </div>
                                    </div>
