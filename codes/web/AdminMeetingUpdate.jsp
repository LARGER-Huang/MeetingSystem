                ...
                <div class="co-lg-10 col-lg-offset-1 col-12">
                    <div class="row">
                        <div class="col col-lg-6 col-12">
                            <a href="AdminMeeting.jsp"><h3>☛返回</h3></a>
                            <div class="contact-form">
                                <h2>会议修改表</h2>
                                <form method="post" action="AdminMeetingUpdate" class="contact-validation-active" id="contact-form-main">
                                    <label>会议号:</label>
                                    <input type="number" class="form-control" name="meetingId"  value="<%=request.getParameter("meetingId")%>" readonly>

                                    <label>ID:</label>
                                    <input type="number" class="form-control" name="id"  value="<%=request.getParameter("org_ID")%>" readonly>
