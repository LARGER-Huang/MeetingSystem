                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-12">
                            ...
                            <div class="contact-form">
                                <h2>个人信息修改表</h2>
                                <form method="post" action="UserMeetingUpdate" class="contact-validation-active" id="contact-form-main">
                                    <%
                                        UserDao userDao=new UserDao();
                                        Org org= null;
                                        try {
                                            org = userDao.getByMeetingId(request.getParameter("meetingId"));
                                        } catch (Exception e) {
                                            e.printStackTrace();
                                        }
                                    %>
