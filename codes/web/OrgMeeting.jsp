                ...
                <div class="col col-lg-6 col-md-7">
                    <div class="wpo-hero-text">
                        <div class="wpo-hero-title">
                            <h2>我发布的会议</h2>
                            <a href="OrgPublish.jsp"><h3 style="color:white">☛返回发布会议</h3></a>
                        </div>
                        <div class="wpo-hero-para">
                            <%
                                ...
                                try {
                                    meeting=orgDao.searchOrgMeeting(org_ID);
                                } catch (Exception e) {
                                    e.printStackTrace();
                                }
                            %>
                            <table style="text-align: center;width: 1000px;color: orange;">
                                ...
                                <tr>
                                    ...
                                    <td><a href="OrgUserMeeting?meetingId=<%=org.getMeetingId()%>" ><p><%=org.getMeetingId()%></p></a></td>
                                    <td><p><%=org.getDate()%></p></td>
                                    <td><p><%=org.getPlace()%></p></td>
                                    <td><p><%=org.getSpeaker()%></p></td>
                                    <td><p><%=org.getHotel()%></p></td>
                                    <td><button><a href="OrgMeetingUpdate.jsp?meetingId=<%=org.getMeetingId()%>">修改<a></button></td>
                                    <td><button><a href="OrgMeetingDelete?meetingId=<%=org.getMeetingId()%>">删除</a></button></td>
                                </tr>
                                <%}
                                }
