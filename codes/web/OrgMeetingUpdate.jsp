                    ...
                    <div class="row">
                        <div class="col col-lg-6 col-12">
                            ...
                            <div class="contact-form">
                                <h2>会议修改表</h2>
                                <form method="post" action="OrgMeetingUpdate" class="contact-validation-active" id="contact-form-main">
                                    <label>会议号:</label>
                                    <input type="number" class="form-control" name="meetingId"  value="<%=request.getParameter("meetingId")%>" readonly>

                                    <label>ID:</label>
                                    <input type="number" class="form-control" name="id"  value="<%=request.getSession().getAttribute("org_ID")%>" readonly>
